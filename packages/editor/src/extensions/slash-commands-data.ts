...
export const SLASH_COMMAND_DEFS: SlashCommandDef[] = [
  ...
  },
  {
    ...
    icon: "•",
    tiptapCommand: "toggleBulletList",
  },
  {
    name: "orderedList",
    label: "Numbered List",
    ...
    icon: "1.",
    tiptapCommand: "toggleOrderedList",
  },
  {
    name: "codeBlock",
    label: "Code Block",
  ...
  },
  {
    ...
    icon: '"',
    tiptapCommand: "toggleBlockquote",
  },
  {
    name: "horizontalRule",
    label: "Divider",
    ...
    icon: "—",
    tiptapCommand: "setHorizontalRule",
  },
  {
    name: "callout",
    label: "Callout",
    ...
    icon: "!",
    insertContent: '<Callout type="info">\n\n</Callout>',
  },
  {
    name: "tabs",
    label: "Tabs",
  ...
  },
  {
    ...
    icon: "▶",
    insertContent: '<Accordion title="Click to expand">\n\n</Accordion>',
  },
  {
    name: "card",
    label: "Card",
