...
export const NavigationGroupSchema: z.ZodType<NavigationGroup> = z.object({
  group: z.string(),
  pages: z.array(z.union([z.string(), z.lazy(() => NavigationGroupSchema)])),
});
...
// ── CONFIG LOADER ────────────────────────────────────────
const CONFIG_FILES = ["tome.config.js", "tome.config.mjs", "tome.config.ts"];
