...
const CheckIcon = () => (
  <svg
    ...
    width="14"
  >
    <circle cx="12" cy="12" fill="var(--accentFaint)" r="10" stroke="none" />
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
        ...
        >
          ...
          <a
            className="nav-link"
            href="https://github.com/tomehq/tome"
            style={s}
          >
            GitHub
          </a>
    ...
    >
      <div>
        ...
        >
          Beautiful docs,
          <br />
          <em style={{ color: "var(--accent)", fontWeight: 500 }}>
            zero friction.
          </em>
        </h1>
        <p
        ...
        >
          Markdown and MDX to production docs in seconds. Search, theming, API
          references, and AI chat. All included, all open source.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          >
            <CheckIcon /> Optimized for Agents
          </span>
          <span
            style={{
              display: "flex",
          ...
          >
            <CheckIcon /> 4 theme presets included
          </span>
        </div>
      </div>
      <LiquidRing bg="#ffffff" block radius={8}>
        <div
          style={{
            padding: "8px 14px",
            background: "#edeae4",
        ...
        >
          <div style={{ display: "flex", gap: 20 }}>
            ...
            >
              ...
              <div style={{ fontSize: 11, marginBottom: 4, color: "#4a443e" }}>
                Quickstart
              </div>
              <div style={{ fontSize: 11, marginBottom: 4, color: "#4a443e" }}>
                Installation
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Tome is an open-source documentation platform for Markdown and
                MDX. Beautiful docs without the $250/month price tag.
              </p>
              {/* Diataxis link cards */}
              <div
                style={{
              ...
              >
                {[
                  ...
                  {
                    icon: "M4 17l10 11 4 5M12 19l7 19",
                    title: "Reference",
                    desc: "CLI & config",
                  },
                  {
                    icon: "M9 18h6M10 22h4M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14",
                    title: "Concepts",
                    desc: "Architecture",
                  },
                ].map((c) => (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 9, color: "#8a847c" }}>
                      {c.desc}
                    </div>
                  </div>
                ))}
              ...
              >
                Tome transforms your Markdown and MDX files into stunning,
                fully-searchable documentation sites.
              </p>
            </div>
          </div>
        </div>
    ...
    if (typing) {
      if (text.length < domain.length) {
        timerRef.current = setTimeout(
          () => setText(domain.slice(0, text.length + 1)),
          80 + Math.random() * 40
        );
      } else {
...
function FeaturesContent() {
  return (
    <div style={{ maxWidth: 1200, width: "100%", padding: "0 48px" }}>
      ...
      >
        <LiquidRing bg="var(--sf)" block radius={12} style={{ height: "100%" }}>
          <div
          ...
          >
            ...
            >
              Deploy your docs with every commit. GitHub, GitLab, and Bitbucket
              supported out of the box with zero-config preview environments.
            </p>
            <div
              style={{
            ...
            >
              <div style={{ color: "var(--accent)", marginBottom: 2 }}>
                <span style={{ color: "var(--txM)" }}># </span>tome.yaml
              </div>
              <div style={{ color: "var(--accent)" }}>deploy:</div>
              <div style={{ color: "var(--tx2)", paddingLeft: 16 }}>
                on: push
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              Your brand, your identity. Fully managed SSL certificates and
        ...
        >
          ...
          >
            ...
            >
              Markdown, MDX, and Markdoc support. Designed by developers who
              value speed.
            </p>
          </div>
        </LiquidRing>
        <LiquidRing bg="var(--sf)" block radius={12} style={{ height: "100%" }}>
          ...
          >
            ...
            >
              Instant results across all your projects with AI-powered semantic
              understanding.
            </p>
            <div
              style={{
...
function CodeExampleContent() {
  ...
  return (
    <div style={{ maxWidth: 700, width: "100%", padding: "0 48px" }}>
      ...
      <LiquidRing bg="var(--bgAlt)" block radius={8}>
        <div
          style={{
            borderRadius: 8,
            overflow: "hidden",
            background: "var(--bgAlt)",
            boxShadow:
              "0 4px 16px var(--shadowColor), 0 1px 4px var(--shadowColorLight)",
          }}
        >
          <div
            style={{
          ...
          >
            ...
            <button
              ...
              style={{
                background: "none",
                border: "none",
                color: copied ? "var(--accent)" : "var(--txM)",
                cursor: "pointer",
                display: "flex",
                alignItems: "center",
                gap: 4,
...
function CTAContent() {
  return (
    <div style={{ maxWidth: 900, width: "100%", padding: "0 48px" }}>
      <LiquidRing bg="var(--accent)" block onAccent radius={16}>
        <div
          style={{
            background: "var(--accent)",
            borderRadius: 16,
            ...
            textAlign: "center",
            boxShadow:
              "0 8px 32px rgba(0,0,0,0.25), 0 3px 12px rgba(0,0,0,0.15)",
          }}
        >
          <h2
            style={{
          ...
          >
            ...
            >
              <CheckIconWhite /> Open source core
            </span>
            <span
              style={{
                display: "flex",
            ...
            >
              <CheckIconWhite /> Built-in AI chat
            </span>
            <span
              style={{
                display: "flex",
            ...
            >
              <CheckIconWhite /> Deploy in seconds
            </span>
          </div>
        </div>
      </LiquidRing>
...
export function App() {
  ...
  return (
    ...
    >
      ...
      <Section active={current === 0} direction={direction}>
        <HeroContent />
      </Section>
      <Section active={current === 1} direction={direction}>
        <FeaturesContent />
      </Section>
      <Section active={current === 2} direction={direction}>
        <CodeExampleContent />
      </Section>
      <Section active={current === 3} direction={direction}>
        <CTAContent />
      </Section>
      <Analytics />
    </div>
